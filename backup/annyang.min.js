...
!function(a, b) {
    ...
    var e,
        ...
        w = function(a, b) {
            a.indexOf("%c") !== -1 || b ? (b = b || l, console.log(a, b)) : console.log(a)
        },
        x = function() {
            v() || c.init({}, !1)
        },
    ...
    return c = {
        init: function(l, o) {
            o = o === b || !!o, e && e.abort && e.abort(), e = new d, e.maxAlternatives = 5, e.continuous = "http:" === a.location.protocol, e.lang = "en-US", e.onstart = function() {
                n = !0, u(h.start)
                ...
                if (m)
                    return k && w("Speech heard, but annyang is paused"), !1;
